        ...
        <div class="min-h-screen relative">
            ...
            <div class="absolute inset-0 z-0">
                <img src="{{ asset('images/paddy.jpg') }}" alt="KADA Background" 
                    class="w-full h-full object-cover opacity-45"> <!-- Light opacity for better readability -->
            </div>
            ...
            <div class="relative z-10">
                <div class="py-12">
                    <div class="max-w-2xl mx-auto">
                        <div class="bg-white/50 overflow-hidden shadow-sm sm:rounded-lg"> <!-- Reduced opacity from 95 to 80 -->
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="mt-6 bg-gray-50 rounded-lg p-4">
                                                ...
                                                <div class="bg-white p-4 rounded-lg shadow-sm mt-4">
                                                    ...
                                                    <textarea id="address" name="address" class="mt-1 block w-full bg-gray-50 border border-gray-300 rounded-lg p-2 focus:ring focus:ring-blue-300 focus:outline-none" required placeholder="Masukkan alamat penuh" rows="4"></textarea>
                                                ...
                                                <div class="grid grid-cols-3 gap-4 mt-4">
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        ...
                                                        <x-text-input id="postcode" name="postcode" type="text" class="mt-1 block w-full bg-gray-50" required maxlength="5" placeholder="Masukkan poskod" />
                                                ...
                                                <div class="mt-8">
                                                    ...
                                                    <textarea id="office_address" name="office_address" class="mt-1 block w-full bg-gray-50 border border-gray-300 rounded-lg p-2 focus:ring focus:ring-blue-300 focus:outline-none" required placeholder="Masukkan alamat penuh" rows="4"></textarea>
                                                 ...
                                                 <div class="grid grid-cols-3 gap-4 mt-4">
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        ...
                                                        <x-text-input id="office_city" name="office_city" type="text" class="mt-1 block w-full bg-gray-50" required placeholder="Masukkan nama bandar" />
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        ...
                                                        <x-text-input id="office_postcode" name="office_postcode" type="text" class="mt-1 block w-full bg-gray-50" required maxlength="5" placeholder="Masukkan poskod" />
                                                    ...
                                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                                        ...
                                                        <select id="office_state" name="office_state" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm bg-gray-50" required>
                                                            <option value="">Pilih Negeri</option>
                                                            <option value="Johor">Johor</option>
                                                            <option value="Kedah">Kedah</option>
                                                            <option value="Kelantan">Kelantan</option>
                                                        ...
                                                        <x-input-error :messages="$errors->get('office_state')" class="mt-2" />
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="space-y-4">
                                                                        ...
                                                                        <div class="bg-white p-4 rounded-lg shadow-sm">
                                                                            <div class="flex items-center mb-2">
                                                                                ...
                                                                                <x-input-label for="no_pf" value="No. PF" class="font-semibold text-gray-700" />
                                                                            </div>
                                                                            <x-text-input id="no_pf" name="no_pf" type="text" class="mt-1 block w-full bg-gray-50" required placeholder="Masukkan nombor PF" />
